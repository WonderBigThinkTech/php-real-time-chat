        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if ($ip_exists > 0) {
                ...
                if ($user_exists > 0) {
                    ...
                    // PHPMailer settings
                    $mail->isSMTP();
                    $mail->Host       = 'server119.web-hosting.com'; // Set the SMTP server to send through
                    $mail->SMTPAuth   = true;
                    $mail->Username   = 'mailer@melonns.com'; // SMTP username
                    $mail->Password   = 'PIrNq5kZ~atm';    // SMTP password
                    $mail->SMTPSecure = PHPMailer\PHPMailer\PHPMailer::ENCRYPTION_STARTTLS;
                    $mail->Port       = 587;

                    // Email subject and body content
                    $mail->setFrom('mailer@melonns.com', 'FaucetMineHub');
                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="/" class="logo-link">
                                <img class="logo-light logo-img logo-img-lg" src="https://faucetminehub.com/images/FMH_LOGO_01.png" srcset="https://faucetminehub.com/images/FMH_LOGO_01.png" alt="logo">
                                <img class="logo-dark logo-img logo-img-lg" src="https://faucetminehub.com/images/FMH_LOGO_01.png" srcset="https://faucetminehub.com/images/FMH_LOGO_01.png" alt="logo-dark">
                            </a>
                        </div>
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-control-xs custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="checkbox">I agree to <?php echo htmlspecialchars($appName); ?> <a href="#">Privacy Policy</a> &amp; <a href="#"> Terms.</a></label>
                                        </div>
                                    </div>
                                ...
                                <br>
                                <center>
                                    <div id="ad_unit" data-unit-id="6624"></div>
