        ...
        <div class="nk-content-body">
            ...
            <nav>
                <ul class="pagination">
                    ...
                    <?php if ($page > 1): ?>
                        <li class="page-item">
                            <a class="page-link" href="referral-earnings?page=<?php echo $page - 1; ?>" tabindex="-1" aria-disabled="true">Prev</a>
                        </li>
                    <?php else: ?>
                    ...
                    <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                        ...
                        <?php else: ?>
                            <li class="page-item">
                                <a class="page-link" href="referral-earnings?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                            </li>
                        <?php endif; ?>
                    <?php endfor; ?>
                    ...
                    <?php if ($page < $total_pages): ?>
                        <li class="page-item">
                            <a class="page-link" href="referral-earnings?page=<?php echo $page + 1; ?>">Next</a>
                        </li>
                    <?php else: ?>
                        <li class="page-item disabled">
