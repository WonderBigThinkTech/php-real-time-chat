...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Check if user has enough balance in the selected cryptocurrency
    if (isset($daily_reward_rate) && $amount > $user[$currency . '_balance']) {
        $error_message = 'Insufficient balance.';
    } elseif (isset($daily_reward_rate)) {
        ...
        // Insert staking record with daily reward rate
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="currency">Select Cryptocurrency to Stake:</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="amount" id"amount" min="0.00000001" required>
                        </div>
                    </div>
