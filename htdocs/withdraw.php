...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!is_numeric($amount) || $amount <= 0) {
        ...
        $message = '<div class="alert alert-danger">The minimum withdrawal amount is 0.00000001 ' . strtoupper($currency) . '.</div>';
    } else {
        ...
        if ($amount > $user_balance) {
            ...
            file_put_contents('withdraw_debug.txt', "User ID: $user_id, Before: Balance: $user_balance, Amount: $amount, Currency: $currency\n", FILE_APPEND);
            ...
            <div class="buysell wide-xs m-auto">
                ...
                <div class="buysell-block">
                    ...
                    <form method="POST" class="buysell-form">
                                ...
                                <a href="#" class="buysell-cc-choosen dropdown-indicator" data-bs-toggle="dropdown" id="dropdown-toggle">
                                    <div class="coin-item coin-btc">
                                        ...
                                        <div class="coin-info">
                                            ...
                                            <span class="coin-text" id="selected-coin-balance"><?php echo $user_balances['btc']; ?></span>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div class="buysell-field form-group">
                            <div class="form-label-group">
                                <label class="form-label" for="amount">Amount to Withdraw (<a href="#" id="min-amount">min: 0.00000001</a>):</label>
                            </div>
                            <div class="form-control-group">
                                <input type="number" class="form-control form-control-lg form-control-number" id="amount" name="amount" placeholder="Enter withdrawal amount" required min="0.00000001" step="0.00000001">
...
document.getElementById('min-amount').addEventListener('click', function(e) {
    ...
    document.getElementById('amount').value = '0.00000001'; // Auto-fill with the minimum amount
});
</script>
