    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($user) {
            ...
            elseif (password_verify($password, $user['password'])) {
                ...
                $stmt_update_fingerprint = $pdo->prepare("UPDATE users SET fingerprint = :fingerprint WHERE id = :user_id");
...
<body class="nk-body bg-white npc-general pg-auth">
                    ...
                    <div class="nk-block nk-block-middle nk-auth-body wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="/" class="logo-link">
                                <img class="logo-light logo-img logo-img-lg" src="https://faucetminehub.com/images/FMH_LOGO_01.png" alt="logo">
                                <img class="logo-dark logo-img logo-img-lg" src="https://faucetminehub.com/images/FMH_LOGO_01.png" alt="logo-dark">
                            </a>
                        </div>
    ...
    <div class="form-group">
        <label>
            <input type="checkbox" name="remember_me" value="1"> Keep me logged in for 7 days
        </label>
    </div>
